...
const ShapeOverlay = ({ onComplete }: ShapeOverlayProps) => {
  ...
  return (
    <svg
      ref={overlayRef}
      className={styles['shape-overlays']}
      viewBox="0 0 100 100"
      preserveAspectRatio="none"
    >
      <defs>
        <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#101312" />
          <stop offset="100%" stopColor="#773f3f" />
        </linearGradient>
        <linearGradient id="gradient2" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#7b3e3e" />
          <stop offset="100%" stopColor="#8b4444" />
        </linearGradient>
      </defs>
